...
test('can play a game of tic tac toe', () => {
  ...
  // prettier-ignore
  const [
    s1, s2, s3, // eslint-disable-line no-unused-vars, @typescript-eslint/no-unused-vars
    s4, s5, s6, // eslint-disable-line no-unused-vars, @typescript-eslint/no-unused-vars
    s7, s8, s9 // eslint-disable-line no-unused-vars, @typescript-eslint/no-unused-vars
