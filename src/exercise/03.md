...
When lifting in this case the parent element e.g. app would have the state management within and not in the name or favAnimal components. this value is then passed down. 

the other side of the coin on lifting 
...
So to get the output for the extra credit, the JSX tag in the name on the app main
has its properties removed, and the display <div> tag is modified to show the desired output.
