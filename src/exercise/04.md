...
I didn't quite understand _what_ lesson 2 extra credit 4 was asking until now, so I'd put that on hold. Now I understand the purpse of that exercise. Local storage is a string type and there may be multiple types of objects that you need to serialize and deserialize. The default functions are just JSON.stringify and JSON.parse. Now I can go back and complete that exercise.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=s.rachael%40gmail.com).
